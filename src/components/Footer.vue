...
<template>
    ...
    <ul class="space-y-2 text-sm">
        ...
        <li><RouterLink to="/contact" class="hover:text-yellow-300">Contacts</RouterLink></li>
    </ul>
    </div>
    <div>
        ...
        <ul class="space-y-2 text-sm">
            ...
            <li><RouterLink to="/kigali" class="hover:text-yellow-300">Kigali City</RouterLink></li>
   ...
   <p class=" text-center"> &copy; 2025 DONE BY MANZI ALLAN. All rights reserved.©</p>
    </div>
